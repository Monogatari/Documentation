...
| ---------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| resource   | `string` | <p>The resource to use as the background. This resource may be one of the following: </p><ul><li><em>Asset ID</em>: The ID of a scene asset previously defined.</li><li><em>CSS Property</em>: Any valid non-spaced value for the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/background">background CSS property</a>.</li></ul> |
| animations | `string` | Optional. A list of comma separated animation names with which the background will be shown.                                                                                                                                                                                                                                                   |
