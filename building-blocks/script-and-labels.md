...
{% content-ref url="../configuration-options/game-configuration/internationalization.md" %}
[internationalization.md](../configuration-options/game-configuration/internationalization.md)
{% endcontent-ref %}
...
{% content-ref url="../configuration-options/split.md" %}
[split.md](../configuration-options/split.md)
{% endcontent-ref %}
