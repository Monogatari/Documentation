...
| -------------------- | --------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`               | `string`  | Yes      | <p>The name that will be shown when this character speaks.</p><p></p><p>Supports storage and translation interpolations.</p>                                                                                              |
...
| `sprites`            | `object`  | Yes      | An object with the identifiers and file names for each [sprite](https://developers.monogatari.io/documentation/v/develop/script-actions/characters) available for the character.                                          |
| `default_expression` | `string`  | Yes      |  [Side image](https://developers.monogatari.io/documentation/v/develop/script-actions/dialogs#side-images) to show every time the character speaks.                                                                       |
| `expressions`        | `object`  | Yes      | An object with the identifiers and file names for each [side expression](https://developers.monogatari.io/documentation/v/develop/script-actions/dialogs#side-images) available for the character.                        |
| `nvl`                | `boolean` | Yes      | <p>Default is <code>false</code>.</p><p></p><p>Whether the character's dialogs should be shown in <a href="https://developers.monogatari.io/documentation/v/develop/script-actions/dialogs#nvl-dialogs">NVL mode</a>.</p> |
| `type_animation`     | `boolean` | Yes      | <p>Default is <code>true</code>. </p><p></p><p>This property indicates whether the typewriter animation should be used when the character speaks or not.</p>                                                              |
...
{% content-ref url="../script-actions/characters.md" %}
[characters.md](../script-actions/characters.md)
{% endcontent-ref %}
...
{% content-ref url="../script-actions/dialogs.md" %}
[dialogs.md](../script-actions/dialogs.md)
{% endcontent-ref %}
...
{% content-ref url="../components/text-box.md" %}
[text-box.md](../components/text-box.md)
{% endcontent-ref %}
