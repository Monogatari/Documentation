...
You can take a look to the script of The Question in [Ren'py](http://www.renpy.org/doc/html/thequestion.html) and this Monogatari Script so you can compare and learn more! If you want, you can also [download the full The Question game made in Monogatari here](https://datadyne.perfectdark.space/monogatari/community/samples/The%20Question.zip).
